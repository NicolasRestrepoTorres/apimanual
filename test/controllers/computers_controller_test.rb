...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { architecture: @computer.architecture, bought: @computer.bought, brand: @computer.brand, ram: @computer.ram } }, as: :json
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { architecture: @computer.architecture, bought: @computer.bought, brand: @computer.brand, ram: @computer.ram } }, as: :json
    assert_response 200
  end
